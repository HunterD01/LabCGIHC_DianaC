...
int main()
{
	...
	CrearCilindro(20, 1.0f);//índice 2 en MeshList  (RENDER, R)
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//CUADRADO VERDE FUERTE PISO
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos
		model = glm::translate(model, glm::vec3(0.0f, -1.41f, -4.0f));
		model = glm::scale(model, glm::vec3(6.1f, 0.2f, 6.1f));
		...
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos5
		model = glm::translate(model, glm::vec3(0.0f, 1.52f, -4.0f));
		model = glm::scale(model, glm::vec3(2.7f, 1.5f, 2.3f));
		//otras transformaciones para el objeto
		//model = glm::scale(model, glm::vec3(0.5f,0.5f,0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//la línea de proyección solo se manda una vez a menos que en tiempo de ejecución
		...
		//PIRÁMIDE CUADRANGULAR CAFE DERECHA
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos5
		model = glm::translate(model, glm::vec3(1.8f, -0.19f, -4.0f));
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0, 0.5f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[4]->RenderMeshGeometry();

		//PIRÁMIDE CUADRANGULAR CAFE IZQUIERDA
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos5
		model = glm::translate(model, glm::vec3(-1.8f, -0.19f, -4.0f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		...
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos
		model = glm::translate(model, glm::vec3(-0.5f, 0.2f, -3.09f));
		model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.3f));
		//otras transformaciones para el objeto
		//model = glm::scale(model, glm::vec3(0.5f,0.5f,0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//la línea de proyección solo se manda una vez a menos que en tiempo de ejecución
		...
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, -3.09f));
		model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.3f));
		//otras transformaciones para el objeto
		//model = glm::scale(model, glm::vec3(0.5f,0.5f,0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos
		model = glm::translate(model, glm::vec3(0.91f, 0.2f, -3.5f));
		model = glm::scale(model, glm::vec3(0.3f, 0.7f, 0.7f));
		//otras transformaciones para el objeto
		//model = glm::scale(model, glm::vec3(0.5f,0.5f,0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//la línea de proyección solo se manda una vez a menos que en tiempo de ejecución
		...
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos
		model = glm::translate(model, glm::vec3(0.91f, 0.2f, -4.46f));
		model = glm::scale(model, glm::vec3(0.3f, 0.7f, 0.7f));
		//otras transformaciones para el objeto
		//model = glm::scale(model, glm::vec3(0.5f,0.5f,0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		//Traslación inicial para posicionar en -Z a los objetos
		model = glm::translate(model, glm::vec3(0.0f, -0.2f, -4.8f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.58f, 0.5f));
		//otras transformaciones para el objeto
		//model = glm::scale(model, glm::vec3(0.5f,0.5f,0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//la línea de proyección solo se manda una vez a menos que en tiempo de ejecución
